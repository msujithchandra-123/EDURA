...
export const Textarea: React.FC<TextareaProps> = ({ label, id, error, className, ...props }) => {
  ...
  return (
    <div className="w-full">
      ...
      <textarea
        id={id}
        className={`bg-gray-50 border text-gray-900 sm:text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:placeholder-gray-400 dark:text-white min-h-[100px] ${errorStyles} ${className}`}
        {...props}
      />
